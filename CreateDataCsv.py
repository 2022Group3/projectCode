...
if __name__ == '__main__':
     batch_file=r"C:\פרוייקט בוטקמפ\dataset\cifar-10-batches-py"
     meta_file = r"C:\פרוייקט בוטקמפ\dataset\cifar-10-batches-py\batches.meta"
     ...
     cfar100_file=r"C:\פרוייקט בוטקמפ\dataset\cifar-100-python"
